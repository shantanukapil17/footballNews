(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /Users/shantanu/Desktop/untitled folder 2/footballNews/src/main.ts */
      "zUnb");
      /***/
    },
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      function AppComponent_article_12_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var AppComponent = /*#__PURE__*/function () {
        ...
        _createClass(AppComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.http.get(this.baseUrl + "getAll").subscribe(function (res) {
              _this.footballNews = res.response.result.video;
            });
          }
        }, {
          key: "pageChange",
          value: function pageChange($event) {
            ...
            this.p = $event;
            this.http.get(this.baseUrl + "getAll?page=" + this.p + "&limit=" + this.limit).subscribe(function (res) {
              _this2.footballNews = res.response.result.video;
            });
          }
        }, {
          key: "filterNewsCards",
          value: function filterNewsCards() {
            var _this3 = this;

            if (this.searchNews.length >= 3) {
              this.http.get(this.baseUrl + "getAll?" + "search=" + this.searchNews).subscribe(function (res) {
                _this3.footballNews = res.response.result.video;
              });
            } else {
              this.http.get(this.baseUrl + "getAll?limit=15").subscribe(function (res) {
                _this3.footballNews = res.response.result.video;
              });
            }
          }
          ...
          key: "sortNewsCards",
          value: function sortNewsCards() {
            if (this.sortAsc === 'ASC') {
              var sortedActivities = lodash__WEBPACK_IMPORTED_MODULE_0__["sortBy"](this.footballNews, ['published_datetime']);
              this.footballNews = sortedActivities;
              console.log('footballNews', this.footballNews);
              this.sortAsc = 'DES';
            } else if (this.sortAsc === 'DES') {
              var _sortedActivities = lodash__WEBPACK_IMPORTED_MODULE_0__["sortBy"](this.footballNews.reverse(), ['published_datetime']);

              this.footballNews = _sortedActivities;
              this.sortAsc = 'ASC';
            }
          }
        }]);
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 15,
        vars: 8,
        consts: [[1, "sidebar"], ["href", "#dashboard", 1, "active"], [1, "flex"], [1, "search"], ["name", "value", "placeholder", "Search...", 1, "search-box", 3, "ngModel", "ngModelChange", "keyup"], [1, "switch"], ["type", "checkbox", "checked", "", 3, "click"], [1, "slider", "round"], [1, "content"], [1, "cards"], ["class", "card", 4, "ngFor", "ngForOf"], [3, "pageChange"], [1, "card"], ["alt", "Sample photo", 3, "src"], [1, "text"]],
        template: function AppComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_5_listener($event) {
              return ctx.searchNews = $event;
            })("keyup", function AppComponent_Template_input_keyup_5_listener() {
              return ctx.filterNewsCards();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function AppComponent_Template_input_click_8_listener() {
              return ctx.sortNewsCards();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("pageChange", function AppComponent_Template_pagination_controls_pageChange_14_listener($event) {
        ...
        pipes: [ngx_pagination__WEBPACK_IMPORTED_MODULE_5__["PaginatePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["DatePipe"]],
